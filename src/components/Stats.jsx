...
const statsData = [
  {
    ...
    description: "Successful digital products launched",
    accent: "#089ff1",
    detail: "Across 18 industries",
  },
  {
    icon: Users,
    value: 98,
    ...
    accent: "#fcce00",
    detail: "Avg. relationship: 5 years",
  },
  {
    icon: Zap,
    value: 24,
  ...
  },
  {
    ...
    accent: "#fcce00",
    detail: "3 international, 9 regional",
  },
  {
    icon: Globe2,
    value: 30,
  ...
  },
  {
    ...
    description: "Trusted long‑term relationships",
    accent: "#02a1fe",
    detail: "98% renew after year 1",
  },
];
