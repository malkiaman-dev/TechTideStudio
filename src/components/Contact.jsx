    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 7 }}>
      <label
        style={{
          ...
          color: focus ? "#089ff1" : "rgba(255,255,255,0.45)",
      ...
      <div style={{ position: "relative" }}>
        <span
          style={{
            ...
            color: focus ? "#089ff1" : "rgba(255,255,255,0.35)",
            transition: "color .25s",
            pointerEvents: "none",
            display: "flex",
          }}
      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: 1140, margin: "0 auto" }}>
        ...
        >
          ...
          <InfoCard
            Icon={IconPin}
            label="Location"
            value="750 S Main St, Suite 150-61, Keller Texas 76248"
            sub="Suite 150-61, Keller Texas 76248"
              ...
              >
                <div
                  style={{
                    ...
                    height: 38,
                    borderRadius: 11,
                    background: "rgba(8,159,241,0.12)",
                    border: "1px solid rgba(8,159,241,0.3)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    color: "#089ff1",
                  ...
                  <div key={day} style={{ display: "contents" }}>
                    ...
                    <span
                      style={{
                        fontSize: 13,
                        fontWeight: 700,
                        color: hrs === "Closed" ? "rgba(255,255,255,0.2)" : "#fff",
                        textAlign: "right",
                        paddingBottom: 9,
                      }}
                    >
